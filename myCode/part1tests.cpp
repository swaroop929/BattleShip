...
void part1tests(){
	...
	assertTrue(Ship{GridPosition{"B8"}, GridPosition{"B12"}}.isValid(),
				"Ship is not valid");
	assertTrue(Ship{GridPosition{"A1"}, GridPosition{"A3"}}.getBow() == GridPosition{"A1"},
				"Ship's bow is not A1");
	assertTrue(!((string)Ship{GridPosition{"A1"}, GridPosition{"A3"}}.getBow() != (string)GridPosition{"A1"}),
				"Ship's bow is not A1");
